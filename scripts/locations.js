...
function createMap(d) {
    d.d.results.forEach((ld, i) => {
        g.get(g.url2 + ld.STREET + "-" + ld.HOUSNUMBER + ",+" + ld.CITY + g.format2).then(e => {
            g.e("#main").innerHTML += "<iframe id=\"map" + i + "\" width=\"425\" height=\"350\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\" style=\"border: 1px solid black\"></iframe><p class='mapTitle'>" + ld.NAME + "<br />" + ld.STREET + " " + ld.HOUSNUMBER +  "<br />" + ld.CITY + "</p>";
            maps.push(g.e("#map" + i));
